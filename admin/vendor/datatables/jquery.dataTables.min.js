...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": 升序排序",sSortDescending:": 降序排序"},oPaginate:{sFirst:"首页",sLast:"尾页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"无数据",sInfo:"共 _TOTAL_ 条（_START_-_END_）",sInfoEmpty:"显示 0 条",
sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_",sLoadingRecords:"加载中...",sProcessing:"处理中...",sSearch:"搜索",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"未找到记录"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
