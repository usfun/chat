...
$(document).on('click', '.delete-chats', function(e) {
    var room_id = $(this).data('id');
    if (confirm('{{_("确定清空该群聊天记录吗？此操作不可恢复！")}}')) {
        $.ajax({
...
//   "timeOut": "5000000",
    ...
    var clipboard = new ClipboardJS('.nmshare a');
    clipboard.on('success', function(e) {
        toastr["success"]("{{_('复制成功')}}");
        e.clearSelection();
    });
